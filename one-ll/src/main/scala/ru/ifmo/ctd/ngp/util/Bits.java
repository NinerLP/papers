...
public final class Bits {
    ...
    @NotNull
    private static final int[] BIT_COUNT = new int[1 << 16];
    static {
        for (int i = 1; i < BIT_COUNT.length; ++i) {
            BIT_COUNT[i] = (byte) (1 + BIT_COUNT[i & (i - 1)]);
        }
    }
    private static final int MASK_16_BIT = (1 << 16) - 1;
    private static final long MASK_32_BIT = (1L << 32) - 1;
    ...
    public static int bitCount(short a) {
        return BIT_COUNT[a & MASK_16_BIT];
    }
    ...
    public static int bitCount(int a) {
        return BIT_COUNT[a & MASK_16_BIT] + BIT_COUNT[a >>> 16];
    }
    ...
    public static int bitCount(long a) {
        return bitCount((int) (a & MASK_32_BIT)) + bitCount((int) (a >>> 32));
    }
